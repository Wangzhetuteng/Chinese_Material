    ...
    public class RestaurantData : DropCreateDatabaseAlways<RestaurantStoreContext>
    {
        protected override void Seed(RestaurantStoreContext context)
        {
            ...
            new List<FoodItem>
            {
                ...
                new FoodItem { Title = "Kung Pao Chicken", FoodType = foodtypes.Single(g => g.Name == "Pin Yin"), Price = 10.25M, ShortDescription = "Salty & Spicy", DetailedDescription="Quick-fried with cashew nuts, chili peppers and onions. Our hot favorite", FoodItemThumbnailImageUrl = "/Assets/Images/KungPaoChickenThumbnail.jpg", FoodItemLargeImageUrl = "/Assets/Images/" },
                new FoodItem { Title = "Moo shu Beef", FoodType = foodtypes.Single(g => g.Name == "Pin Yin"), Price = 9.95M, ShortDescription = "Salty & Spicy", DetailedDescription="A Chinese classic served with julienne vegetables, hoisin sauce and thin pancakes", FoodItemThumbnailImageUrl = "/Assets/Images/MooShuBeefThumbnail.jpg", FoodItemLargeImageUrl = "/Assets/Images/" },
                new FoodItem { Title = "Salt & spicy Ribs", FoodType = foodtypes.Single(g => g.Name == "Pin Yin"), Price = 8.85M, ShortDescription = "Salty & Spicy", DetailedDescription="Deep fried boneless spare ribs seasoned with spicy salt, chili & herbs", FoodItemThumbnailImageUrl = "/Assets/Images/Salt&SpicyRibsThumbnail.jpg", FoodItemLargeImageUrl = "/Assets/Images/" },

                new FoodItem { Title = "Jumbo Shrimps", FoodType = foodtypes.Single(g => g.Name == "Characters"), Price = 15.25M, ShortDescription = "Spicy", DetailedDescription="Large shrimps served on a skillet with vegetables. Topped with our spicy garlic sauce", FoodItemThumbnailImageUrl = "/Assets/Images/JumboShrimpsThumbnail.jpg", FoodItemLargeImageUrl = "/Assets/Images/" },
                new FoodItem { Title = "Shrimp with Lobster Sauce", FoodType = foodtypes.Single(g => g.Name == "Characters"), Price = 12.50M, ShortDescription = "Salty", DetailedDescription="Garlic white wine sauce with Chinese black beans, mushroom, onion and egg",FoodItemThumbnailImageUrl = "/Assets/Images/ShrimpwithLobsterSauceThumbnail.jpg", FoodItemLargeImageUrl = "/Assets/Images/" },
                new FoodItem { Title = "Sweet Chilli Shrimp", FoodType = foodtypes.Single(g => g.Name == "Characters"), Price = 13.50M, ShortDescription = "Sweet & Spicy", DetailedDescription="Hand-battered shrimp prepared to order and tossed in a spicy chilli sauce",FoodItemThumbnailImageUrl = "/Assets/Images/SweetChilliShrimpThumbnail.jpg", FoodItemLargeImageUrl = "/Assets/Images/" },
