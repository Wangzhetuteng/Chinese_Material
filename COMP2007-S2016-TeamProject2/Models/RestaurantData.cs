    ...
    public class RestaurantData : DropCreateDatabaseAlways<RestaurantStoreContext>
    {
        protected override void Seed(RestaurantStoreContext context)
        {
            ...
            new List<FoodItem>
            {
                ...
                new FoodItem { Title = "Salt & spicy Ribs", FoodType = foodtypes.Single(g => g.Name == "Pin Yin"), Price = 8.85M, ShortDescription = "Salty & Spicy", DetailedDescription="Deep fried boneless spare ribs seasoned with spicy salt, chili & herbs", FoodItemThumbnailImageUrl = "/Assets/Images/Salt&SpicyRibsThumbnail.jpg", FoodItemLargeImageUrl = "/Assets/Images/Salt&SpicyRibsLarge.jpg" },
